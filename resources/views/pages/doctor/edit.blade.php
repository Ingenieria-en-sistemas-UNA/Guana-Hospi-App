...
<div class="card w-100 p-5 mt-3">
    ...
    <form method="post" action="{{ route('doctors.update', $medico->Id_Medico) }}">
        ...
        <div class="form-group">
            ...
            <input value="{{ old('Nombre_Persona', $medico->Nombre_Persona) }}" type="text"
        ...
        <div class="row">
            <div class="col-12 col-sm-6">
                <div class="form-group">
                    ...
                    <input value="{{ old('Primer_Apellido', $medico->Primer_Apellido) }}" type="text"
            ...
            <div class="col-12 col-sm-6">
                <div class="form-group">
                    ...
                    <input value="{{ old('Segundo_Apellido', $medico->Segundo_Apellido) }}" type="text"
        ...
        <div class="row">
            <div class="col-12 col-sm-6">
                <div class="form-group">
                    ...
                    <input value="{{ old('Cedula_Persona', $medico->Cedula_Persona) }}" readonly type="text"
            ...
            <div class="col-12 col-sm-6">
                <div class="form-group">
                    ...
                    <input value="{{ old('Edad', $medico->Edad) }}" type="text"
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <select multiple name="specialities[]" class="form-control" id="specialities">
                        ...
                        @endphp
                        @endforeach
                        <option value="{{ $speciality->Id_Especialidad }}" @if($isSelected) selected @endif>
                            {{ $speciality->Nombre_Especialidad }}</option>
                        @endforeach
                    </select>
                    @error('Nombre_Persona')
                    <div class="alert alert-danger">{{ $message }}</div>
        ...
        <div class="row">
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input value="{{ old('Codigo_Medico', $medico->Codigo_Medico) }}" readonly type="text"
